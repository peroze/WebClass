...
<div class="container">
    ...
    <?php
        if($id) {
            echo("
                <h1>Επεξεργασία Ανακοίνωσης $id</h1>
                <div class=\"forma\">
                    <form action=\"Include/AnnouncmentChange.php?id=$id\" method=\"post\">
                        <div class=\"inputs\">
                            <input type=\"text\" placeholder=\"Θέμα\" name=\"theme\">
                        </div>
                        <div class=\"inputs\">
                            <textarea rows=\"4\" type=\"text\" name=\"text\" placeholder=\"Γράψτε εδώ το κείμενο... \"></textarea>
                        </div>
                        <div class=\"buttons\">
            ...
            echo("<h1>Δημιουργία Ανακοίνωσης</h1>
                <div class=\"forma\">
                    <form action=\"Include/Announcment.php\" method=\"post\">
                        <div class=\"inputs\">
                            <input type=\"text\" placeholder=\"Θέμα\" name=\"theme\">
                        </div>
                        <div class=\"inputs\">
