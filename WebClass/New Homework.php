    ...
    <div class="content">
        <div class="files">
            <?php
                    if($id) {
                        echo("
                        <h1>Επαιξεργασία  Εργασίας</h1>
                        <div class=\"forma\">
                        <form action=\"Include/HomeworkChange.php?id=$id.php\" enctype=\"multipart/form-data\" method=\"post\">");
                }
                else{
                     echo("
                             <h1>Εισαγωγή Εργασίας</h1>
                              <div class=\"forma\">
                                <form action=\"Include/Homework.php\" enctype=\"multipart/form-data\" method=\"post\">");
            }
            ?>
                    ...
                    <form action="Include/Homework.php" enctype="multipart/form-data" method="post">
                         <div class="inputs">
                            <textarea rows="4" type="text" name="goals" placeholder="Στόχοι τις Εργασίας... "></textarea>
                         </div>
                         <div class="inputs">
                            <textarea rows="4" type="text" name="give" placeholder="Παραδοτέα... "></textarea>
                         </div>
						 <div class="inputs">
